...
**Текущая версия: Solstice 1.07.** Проект находится на этапе подготовки к распространению. Перед публичной продажей готовую сборку необходимо подписать сертификатом Apple Developer ID и нотариализировать.
...
## 13. Производительность и известные границы версии 1.07
