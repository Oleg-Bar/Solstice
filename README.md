...
Нативная macOS-заставка с трёхмерной Землёй, текущим освещением день/ночь и аналоговыми часами городов. Рабочее название — **Terra**, репозиторий — **Solstice**. Версия проекта: **1.0**.
...
## 13. Производительность и известные границы версии 1.0
