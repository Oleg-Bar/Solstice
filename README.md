...
**Текущая версия: Solstice 1.03.** Проект находится на этапе подготовки к распространению. Перед публичной продажей готовую сборку необходимо подписать сертификатом Apple Developer ID и нотариализировать.
